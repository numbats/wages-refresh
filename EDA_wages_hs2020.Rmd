...
Since we have a quite large data set, we have to subset it first to model the data. Here, we would like to build a Generalized Additive Model (GAM) model, by randomly subset the daya the data using brolgar's` `sample_frac_keys` function. 
