...
In this section, we outline the steps taken to the download the raw data from the database provided at [CITE: https://www.nlsinfo.org/content/cohorts/nlsy79/get-data]. Specifically, we only extract a subset of the variables in the database as shown in \ref{box:data}. 
...
::: {.tcolorbox data-latex="[label=\"box:data\", title=\"Getting data\"]" }
...
\begin{itemize}
\item Downloaded all of variables in Highest grade completed.
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item Downloaded all of the variables in Hours worked.
\item Downloaded all of the variables in Hourly wages
...
\begin{itemize}
\item Downloaded year and month of birth, race, and sex variables. There are two versions of the year and month of birth, i.e., 1979 and 1981 data. We downloaded these two versions.
\end{itemize}
\end{itemize}
\end{itemize}
