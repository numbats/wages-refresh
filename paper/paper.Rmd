...
In this section, we outline the steps taken to the download the raw data from the database provided at \url{https://www.nlsinfo.org/content/cohorts/nlsy79/get-data} [@nlsy79]. Specifically, we only extract a subset of the variables in the database as described in Section~\ref{sec:getdata}. 
