...
header-includes:
  ...
  - \newtcolorbox{tbox}{width=\textwidth,boxsep=5pt}
output: 
...
In this section, we outline the steps taken to the download the raw data from the database provided at [CITE]. Specifically, we only extract a subset of the variables in the data base. 
...
::: {.tcolorbox data-latex="[label=\"box:data\"]" }
