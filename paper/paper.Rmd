...
```{r slope-gender, fig.cap="slope-gender"}
...
```{r wages-gender-gap, echo=FALSE, fig.cap="Gender wage gap or the median wages of females relatives to median wages of males. Females tend to earn fewer than males. For example, in 2018 females earn about 78 cents for every $1 earned by males."}
