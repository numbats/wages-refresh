...
In this section, we outline the steps taken to the download the raw data from the database provided at {[}CITE: \url{https://www.nlsinfo.org/content/cohorts/nlsy79/get-data}{]}. Specifically, we only extract a subset of the variables in the database as shown in \ref{box:data}.
...
\begin{tcolorbox}[label="box:data", title="Getting data"]
