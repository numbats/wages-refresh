...
\NormalTok{years <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1979}\OperatorTok{:}\DecValTok{1994}\NormalTok{, }\KeywordTok{seq}\NormalTok{(}\DecValTok{1996}\NormalTok{, }\DecValTok{2018}\NormalTok{, }\DataTypeTok{by =} \DecValTok{2}\NormalTok{))}
\NormalTok{hours_all <-}\StringTok{ }\KeywordTok{map_dfr}\NormalTok{(years, get_hour)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{rename}\NormalTok{(}\DataTypeTok{id =}\NormalTok{ CASEID_}\DecValTok{1979}\NormalTok{)}
\NormalTok{\}}
\NormalTok{rates_all <-}\StringTok{ }\KeywordTok{map_dfr}\NormalTok{(years, get_rate)}
