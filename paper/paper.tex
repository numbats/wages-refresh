...
\NormalTok{                                rate_per_hour),}
         \DataTypeTok{hours_work =} \KeywordTok{ifelse}\NormalTok{(hours_work }\OperatorTok{==}\StringTok{ }\DecValTok{0} \OperatorTok{|}\StringTok{ }\NormalTok{hours_work }\OperatorTok{>}\StringTok{ }\DecValTok{84}\NormalTok{, }\OtherTok{NA}\NormalTok{, hours_work))}
...
{\centering \includegraphics[width=\textwidth]{figures/feature-plot-1} 
...
{\centering \includegraphics[width=\textwidth]{figures/high-wages-1} 
...
{\centering \includegraphics[width=\textwidth]{figures/sample-plot-1} 
...
{\centering \includegraphics[width=\textwidth]{figures/compare-plot-1} 
...
{\centering \includegraphics[width=\textwidth]{figures/comppict-1} 
...
\{\centering \includegraphics[width=\textwidth]{figures/flow-chart-1}

\hypertarget{exploratory-data-analysis}{%
\section{Exploratory Data Analysis}\label{exploratory-data-analysis}}

This part gives some examples of exploratory data analysis using the data. We are interested to explore how people experience changes in their wages over the years. Hence, we focus the analysis in their slope of wages. Using \texttt{key\_slope} function in \texttt{brolgar} (Tierney, Cook, and Prvan 2020), we perform linear regression with the mean hourly wage as response variable and year as the predictor for each individual.

\begin{figure}

{\centering \includegraphics[width=\textwidth]{figures/nobs-plot-1} 

}

\caption{Distribution of observations. The numbers of rounds varies among respondents. Most of respondents participated in 28 rounds of survey.}\label{fig:nobs-plot}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=\textwidth]{figures/slope-nobs-1} 

}

\caption{Distribution of wages slope by number of observations. The slopes' range are more stable with more observations.}\label{fig:slope-nobs}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=\textwidth]{figures/slope-gender-1} 
...
According to OECD (n.d.), gender pay gap is the difference between median wage of males and females relative to median wage of males. We find that, as shown in \ref{fig:se-gender}, over the years, females tend to earn fewer than males. For example, in 2018 females earn about 78 cents for every \$1 earned by males. The widest gender gaps were observed in 1990s.

\textbackslash begin\{figure\}

\{\centering \includegraphics[width=\textwidth]{figures/wages-gender-gap-1}

\}

\textbackslash caption\{Gender wage gap or the median wages of females relatives to median wages of males. Females tend to earn fewer than males. For example, in 2018 females earn about 78 cents for every \$1 earned by males. Note that this is a crude measure as gap is calculated not based on other variable, such as experience and job class.\}\label{fig:wages-gender-gap}
\textbackslash end\{figure\}

\begin{figure}

{\centering \includegraphics[width=\textwidth]{figures/slope-educ-1} 
