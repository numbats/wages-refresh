...
```{r rlm, cache=TRUE, warning = FALSE, message = FALSE, echo = FALSE}
...
```{r se-gender, echo=FALSE, fig.cap="The yearly mean of mean hourly wage by gender along with its standard error. Males generally earn more wages than females. The error interval tend to be wider over the years."}
