...
This paper aims to demonstrate the steps of IDA, which is tidying, cleaning, and documenting the data. We used the longitudinal data from the National Longitudinal Survey of Youth 1979 or is known as the NLSY79. Particularly, we are interested in doing the IDA to the wages and several demographic variables of the cohort whose highest grade are up to 12th grade and the high school dropouts.  

# The NLSY79

The NLSY79  is a longitudinal survey held by the U.S Bureau of Labor Statistics that follows the lives of a sample of American youth born between 1957-64. The cohort originally included 12,686 respondents ages 14-22 when first interviewed in 1979. There were three race interviewed in the survey, which are Black, Hispanic, and non-Black/non-Hispanic. In 1984 interview, 1,079 members of the military sample were no longer eligible for interview; 201 respondents randomly selected from the military sample remained in the survey. Following the 1990 interview, none of the 1,643 members of the economically disadvantaged, non-Black/non-Hispanic sample were eligible for interview. Hence, 9,964 respondents remain in the eligible samples. The surveys were conducted annually from 1979 to 1994 and biennially thereafter. Data are now available from Round 1 (1979 survey year) to Round 28 (2018 survey year).
