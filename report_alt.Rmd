...
#### using brolgar to explore the individual experiences <- change the EDA
```
...
This paper also has demonstrated the documentation of data cleaning. We also provided all of the codes in performing data tidying and initial data analysis. Thus, this paper provided an opportunity to continuously refresh the text book data whenever the updated data is published in the NLSY79 database. This could be done by following the documentation of the code that is provided in this paper. 
