...
wages <- read_csv("data-raw/wages-high-school-demo/data-frames/tidy_employment_sc1.csv")
...
wages_hs2020_sc1 <- wages_demog_hs %>%
...
save(wages_hs2020_sc1, file="wages_hs2020_sc1.rda")
